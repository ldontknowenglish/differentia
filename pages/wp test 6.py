            ...
            if selected_wells:
                ...
                if len(selected_wells) == 1:
                    ...
                    with st.expander(f"➕ Well [{pos}] 신규 처리 및 사진 작성", expanded=True):
                        ...
                        # 수정 1: 세포유래/출처 제거, 해당 위치에 분석 진행상태 배치
                        ...
                        # 수정 2: Basal Media를 처리 물질 및 농도 맨 위에 오도록 수정
                        if ex_analysis == "미진행":
                    ...
                    if items:
                        ...
                        for item in items:
                            ...
                            with st.expander(f"📅 {item['treatment_date']} | 🧬 {item.get('cell_info', '-')} | 🧪 {formatted_cond}"):
                                ...
                                # 수정 2: Basal Media를 처리 물질 농도 항목의 맨 위에 오도록 수정
                                if mod_analysis == "미진행":
                    ...
                    # 수정 1: 일괄 저장 시에도 세포유래 제거 및 분석 진행상태 배치
...
def render_tab_management(selected_plate, treatments):
    ...
    if treatments:
        ...
        chk_col1, chk_col2 = st.columns([2, 8])
        with chk_col1:
        ...
        for idx, item in enumerate(treatments):
            with list_cols[idx % 2]:
                ...
                with st.expander(f"{img_flag}📍 Well [{item['well_position']}] | 📅 {item['treatment_date']} | 🧬 {item.get('cell_info', '-')} ({analysis_lbl}) | 🧪 {formatted_cond}"):
                    ...
                    # 수정 1: 개별 이력 세부 수정 영역 세포유래 제거 및 분석 진행상태 배치
                    ...
                    # 수정 2: Basal Media를 처리 물질 농도 맨 위에 오도록 수정
                    if e_analysis == "미진행":
