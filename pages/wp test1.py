...
# ======================================================================
# 수정됨: 가로(Horizontal) 흐름 및 동일 세포/실험 통합 추적 계통도 생성 함수
# ======================================================================
def generate_project_cell_lineage_dot(project_id):
    ...
    # 1. 세포 노드(Node) 및 위치(locations) 수집 (동일 세포명 통합)
    ...
    # 2. 계대 태그 [PassageFrom:] 기반 연결 생성 (세포명 및 위치 매칭 지원)
    ...
    # Graphviz Dot 문법 생성 (이스케이프 에러 방지)
    dot_lines = [
